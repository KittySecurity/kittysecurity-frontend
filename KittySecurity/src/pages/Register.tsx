        ...
        <div className="register-header">
            ...
            <div className="register-container">
                <div className="pattern-bot">
                    <img src={patternBotReg} alt="pattern-bot"/>
                </div>
                <div className="pattern-top">
                    <img src={patternTopReg} alt="pattern-top"/>
                </div>
                <div className="register-form">
                    ...
                    <form onSubmit={handleSignup}>
                        ...
                        <Link className="strong-password-link" to="/strong-password">HOW TO CREATE STRONG PASSWORD? CHECK IT OUT HERE</Link>
                        <div>
